...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            if (cause instanceof BlogException commentException) {
     ...
     * 处理 BlogException
     */
    private void handleShopException(HttpServletResponse resp, BlogException commentException) throws IOException {
