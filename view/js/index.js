...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (userLoginBtn) {
        userLoginBtn.addEventListener('click', () => {
            window.location.href = 'user-login.html'; // 跳转到用户登录页面
        });
    }
    ...
    if (userRegisterBtn) {
        userRegisterBtn.addEventListener('click', () => {
            window.location.href = 'user-register.html'; // 跳转到用户注册页面
        });
    }
    ...
    if (shopLoginBtn) {
        shopLoginBtn.addEventListener('click', () => {
            window.location.href = 'shop-login.html'; // 跳转到商铺登录页面
        });
    }
    ...
    if (shopRegisterBtn) {
        shopRegisterBtn.addEventListener('click', () => {
            window.location.href = 'shop-register.html'; // 跳转到商铺注册页面
        });
    }
});